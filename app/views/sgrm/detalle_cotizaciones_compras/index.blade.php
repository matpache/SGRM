...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        @foreach($detalle_cotizacion as $detalle)
            ...
            <td>{{ $detalle->descuento }}</td>
                    <td>
                <a href="{{ action('SGRM\DetalleCotizacionesComprasController@getDelete', array($detalle->id)) }}" class="btn btn-xs btn-default"><i class="fa fa-times"></i> Eliminar</a>
                    </td>
                </tr>
                @endforeach
                </tbody>
    ...
    <div class="modal fade" id="dlgNewCity" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            {{ Form::open(array('action'=> array('SGRM\DetalleCotizacionesComprasController@postAdd', $cotizacion_compra_id))) }}
